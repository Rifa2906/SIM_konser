                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jabatan" id="jabatan_edit" class="form-control">
                                    <option value="staf gudang">staf</option>
                                    <option value="administrator">administrator</option>
                                </select>
                                <span class="text-danger" id="jabatan_edit-error"></span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data['status'] == 0) {
                    ...
                    $("#jabatan-error").html(data['jabatan']);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data['status'] == 0) {
                    ...
                    $("#jabatan_edit-error").html(data['jabatan']);
